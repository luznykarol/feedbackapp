    ...
    comments: [
      {
        ...
        user: {
          image: "../../assets/users/image-elijah.jpg",
          name: "Elijah Moss",
      ...
      },
      {
        ...
        user: {
          image: "../../assets/users/image-james.jpg",
          name: "James Skinner",
        ...
        replies: [
          {
            ...
            user: {
              image: "../../assets/users/image-anne.jpg",
              name: "Anne Valentine",
              username: "annev1990",
            },
          },
          {
            ...
            user: {
              image: "../../assets/users/image-ryan.jpg",
              name: "Ryan Welles",
    ...
    comments: [
      {
        ...
        user: {
          image: "../../assets/users/image-george.jpg",
    ...
    comments: [
      {
        ...
        user: {
          image: "../../assets/users/image-javier.jpg",
          name: "Javier Pollard",
      ...
      },
      {
        ...
        user: {
          image: "../../assets/users/image-roxanne.jpg",
          name: "Roxanne Travis",
    ...
    comments: [
      {
        ...
        user: {
          image: "../../assets/users/image-victoria.jpg",
          name: "Victoria Mejia",
        ...
        replies: [
          {
            ...
            user: {
              image: "../../assets/users/image-zena.jpg",
              name: "Zena Kelley",
      ...
      },
      {
        ...
        user: {
          image: "../../assets/users/image-jackson.jpg",
          name: "Jackson Barker",
